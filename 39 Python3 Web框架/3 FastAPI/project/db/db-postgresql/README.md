...
# or
pip install fastapi uvicorn pydantic pydantic[email] sqlalchemy databases python-multipart psycopg2
```

PostgreSQL 的依赖库 psycopg2 或 asyncpg。通常推荐使用 psycopg2 以获得更好的性能和异步支持。
